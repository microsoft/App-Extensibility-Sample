...
namespace ExtensibilitySample
{
    ...
    public static class AppData
    {
        ...
        private static ExtensionManager extensionManager = new ExtensionManager("build2016.appextensibility.demo");

        // create the current editing image
        public static WriteableBitmap currentImage = new WriteableBitmap(1, 1);
        public static string currentImageString = null;
